...
Período utilizado no momento do cálculo.
...
Série utilizada para o cálculo.
...
dValor1: Valor float a ser comparado com o segundo valor informado dValor2: Valor float a ser comparado com o primeiro valor informado
...
Indica se é uma put ou uma call
...
DaysLeft: Dias uteis até o vencimento da opção StrikePr: Preço do exercício da opção AssetPr: Preço da ação Rate100: Taxa de juros em % Volty100: Volatilidade em % PutCall: Indica se é uma put ou uma call optPut - Opção de venda optCall - Opção de compra
